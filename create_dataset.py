...
def main():
    ...
    parser.add_argument("--dataset_a", default="dataset/News_Category_Dataset_v3.json",
                        help="Path to HuffPost JSON lines file")
    parser.add_argument("--dataset_b", default="dataset/abcnews-date-text.csv",
                        help="Path to ABC News CSV file")
    parser.add_argument("--output", default="headlines_200k.jsonl",
